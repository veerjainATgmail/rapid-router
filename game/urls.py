...
urlpatterns = [
    ...
    url(r'^level_moderation/', include([
        ...
        url(r'^class/(?P<class_id>[0-9]+)/$', get_students_for_level_moderation, name='students_for_level_moderation'),
        url(r'^delete/(?P<levelID>[0-9]+)/$', delete_level, name='delete_level'),
    ])),

    url(r'^level_editor/', include([
        url(r'^$', level_editor, name='level_editor'),
        url(r'^play_anonymous/(?P<levelId>[0-9]+)/$', play_anonymous_level, name='play_anonymous_level'),
        url(r'^play_custom/(?P<levelId>[0-9]+)/$', play_custom_level_from_editor,
